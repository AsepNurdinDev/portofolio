  ...
  return (
    <section className="bg-white py-20" id="contact">
      <div className="max-w-3xl mx-auto px-4">
        ...
        {isSubmitted && (
          <div className="mb-6 rounded-lg bg-green-100 p-4 text-green-800 text-center">
            ✅ Email berhasil dikirim!
          </div>
        )}

        {isError && (
          <div className="mb-6 rounded-lg bg-red-100 p-4 text-red-800 text-center">
        ...
        >
          <div>
            ...
            <input
              ...
              className="mt-1 w-full rounded-md border p-3 focus:ring-indigo-500 focus:border-indigo-500"
            />
          </div>
